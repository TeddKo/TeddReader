 ...
 * @property chapterPageIndex This page's zero-based position and total page count inside its chapter.
 *   Null for a cover, an untitled page, or a page whose chapter bounds are unavailable.
